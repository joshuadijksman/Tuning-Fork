...
def calibrateAir(
    ...
    print(
        f"[CAL] (Normal) Fit results: C={CNormal:.3e}, γ_sys={gammaNormal:.3e}, f_res={f0Normal:.6f} Hz"
    )
    ...
    print(
        f"[CAL] (Shear) Fit results: C={CShear:.3e}, γ_sys={gammaShear:.3e}, f_res={f0Shear:.6f} Hz"
    )
