...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ConnectHeightGauge = QPushButton(self.HeightGaugeFrame)
        self.ConnectHeightGauge.setObjectName(u"ConnectHeightGauge")

        self.gridLayout_27.addWidget(self.ConnectHeightGauge, 2, 0, 1, 1)
        ...
        self.TimeNormalSlider = QScrollBar(self.TimeConstantNormal)
        self.TimeNormalSlider.setObjectName(u"TimeNormalSlider")
        self.TimeNormalSlider.setGeometry(QRect(0, 0, 20, 142))
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.MinimumExpanding)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.TimeNormalSlider.sizePolicy().hasHeightForWidth())
        self.TimeNormalSlider.setSizePolicy(sizePolicy3)
        self.TimeNormalSlider.setBaseSize(QSize(20, 142))
        self.TimeNormalSlider.setMaximum(19)
        self.TimeNormalSlider.setPageStep(1)
        self.TimeNormalSlider.setOrientation(Qt.Orientation.Vertical)
        self.TimeNormalSlider.setInvertedAppearance(True)
        self.TimeNormalSlider.setInvertedControls(False)
        self.TimeNormalGrid = QWidget(self.TimeConstantNormal)
        self.TimeNormalGrid.setObjectName(u"TimeNormalGrid")
        self.TimeNormalGrid.setGeometry(QRect(26, 0, 211, 142))
        ...
        self.TimeNormal3 = QRadioButton(self.TimeNormalGrid)
        self.TimeNormal3.setObjectName(u"TimeNormal3")
        self.TimeNormal3.setAutoExclusive(False)

        self.gridLayout_8.addWidget(self.TimeNormal3, 2, 0, 1, 1)
        ...
        self.SensNormalSlider.setMaximum(26)
        self.SensNormalSlider.setPageStep(1)
        self.SensNormalSlider.setOrientation(Qt.Orientation.Vertical)
        self.SensNormalSlider.setInvertedAppearance(True)
        self.SensNormalSlider.setInvertedControls(False)
        self.SensNormalGrid = QWidget(self.SensitivityNormal)
        self.SensNormalGrid.setObjectName(u"SensNormalGrid")
        self.SensNormalGrid.setGeometry(QRect(26, 0, 211, 142))
        ...
        self.SensNormal2 = QRadioButton(self.SensNormalGrid)
        self.SensNormal2.setObjectName(u"SensNormal2")
        self.SensNormal2.setAutoExclusive(False)

        self.gridLayout_9.addWidget(self.SensNormal2, 2, 0, 1, 1)
        ...
        self.TimeShearSlider.setMaximum(19)
        self.TimeShearSlider.setPageStep(1)
        self.TimeShearSlider.setOrientation(Qt.Orientation.Vertical)
        self.TimeShearSlider.setInvertedAppearance(True)
        self.TimeShearSlider.setInvertedControls(False)
        self.TimeShearGrid = QWidget(self.TimeConstantShear)
        self.TimeShearGrid.setObjectName(u"TimeShearGrid")
        self.TimeShearGrid.setGeometry(QRect(26, 0, 211, 142))
        ...
        self.TImeShearGrid = QGridLayout(self.TimeShearGrid)
        self.TImeShearGrid.setObjectName(u"TImeShearGrid")
        self.TimeShear3 = QRadioButton(self.TimeShearGrid)
        self.TimeShear3.setObjectName(u"TimeShear3")
        self.TimeShear3.setAutoExclusive(False)

        self.TImeShearGrid.addWidget(self.TimeShear3, 2, 0, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShearx100, 1, 1, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShearks, 0, 2, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShearms, 2, 2, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShearx10, 2, 1, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShears, 1, 2, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShearx1, 3, 1, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShearmicros, 3, 2, 1, 1)
        ...
        self.TImeShearGrid.addWidget(self.TimeShear1, 3, 0, 1, 1)
        ...
        self.SensShearSlider.setMaximum(26)
        self.SensShearSlider.setPageStep(1)
        self.SensShearSlider.setOrientation(Qt.Orientation.Vertical)
        self.SensShearSlider.setInvertedAppearance(True)
        self.SensShearSlider.setInvertedControls(False)
        self.SensShearGrid = QWidget(self.SensitivityShear)
        self.SensShearGrid.setObjectName(u"SensShearGrid")
        self.SensShearGrid.setGeometry(QRect(26, 0, 211, 142))
        ...
        self.SensShear2 = QRadioButton(self.SensShearGrid)
        self.SensShear2.setObjectName(u"SensShear2")
        self.SensShear2.setAutoExclusive(False)

        self.gridLayout_7.addWidget(self.SensShear2, 2, 0, 1, 1)
        ...
        self.tabLockInNormal.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ConnectHeightGauge.setText(QCoreApplication.translate("MainWindow", u"Connect", None))
        ...
        self.TimeNormal3.setText(QCoreApplication.translate("MainWindow", u"3", None))
        ...
        self.SensNormal2.setText(QCoreApplication.translate("MainWindow", u"2", None))
        ...
        self.TimeShear3.setText(QCoreApplication.translate("MainWindow", u"3", None))
        ...
        self.SensShear2.setText(QCoreApplication.translate("MainWindow", u"2", None))
